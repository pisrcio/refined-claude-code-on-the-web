  ...
  function watchForCopyBranchButton() {
    ...
    function addPullBranchButton() {
      ...
      pullBranchBtn.innerHTML = `
        ...
        <div class="text-accent-main-100 group-disabled:text-text-500" style="width: 16px; height: 16px; display: flex; align-items: center; justify-content: center;">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="text-accent-main-100 group-disabled:text-text-500" aria-hidden="true" style="flex-shrink: 0;">
